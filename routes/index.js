...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Express', nombre:"Moi" });
});

let crear_tabla = "CREATE TABLE contacto 8(id INTENGER PRIMARY AUTOINCREMENT, nombre VARCHAR(50) NOT NULL, Telefono NOT NULL, Email NOT NULL, mensaje TEXT, fecha TEXT, hora TEXT, ip TEXT);"
